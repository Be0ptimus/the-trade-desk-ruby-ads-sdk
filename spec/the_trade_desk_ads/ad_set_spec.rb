...
describe TheTradeDeskAds::AdSet do
  # def test_create
  #   vcr do
  #     ad_campaign = TheTradeDeskAds::AdCampaign.find('6069436026057')
  ...
  # def test_update
  #   vcr do
  #     ad_set = TheTradeDeskAds::AdSet.find('6078462927057')
  ...
  # def test_destroy
  #   vcr do
  #     ad_set = TheTradeDeskAds::AdSet.find('6081945233457')
